...
def run(context):
    ...
    try:
        ...
        # test.tester()
        witResponse = nlp.streamAudio(_ui) #returns wit response json
        _ui.messageBox('Executing: ' + str(witResponse))
        executionResultCode = fusion_execute_intent.executeCommand(witResponse, _ui)
        _ui.messageBox('Execution Result Code: ' + str(executionResultCode))
#         _app = adsk.core.Application.get()
#         _ui = _app.userInterface
