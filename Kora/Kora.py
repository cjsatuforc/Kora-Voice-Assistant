    ...
    def run(self):
        ...
        try:
            while not self.stopped:
                ...
                # witResponse = json.loads('{ "user": "lkhfdfghj", "witStreamTime": 4.23 , "_text" : "extrude by five centimeters", "entities" : {"extrude_quantity" : [ {"suggested" : "true","entities" : {"number" : [ {"confidence" : 1,"value" : 1,"type" : "value"} ],"units" : [ {"confidence" : 1,"value" : "inches","type" : "value"} ]} } ],"intent" : [ {"confidence" : 0.99996046020482,"value" : "extrude"} ]},"msg_id" : "0TrwCOw1505FzxI2g"}')
