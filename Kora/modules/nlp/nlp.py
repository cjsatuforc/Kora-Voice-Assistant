...
def streamAudio(onSpeechDetectedCallback=None, onSpeechEndCallback=None):
    """
    ...
    try:
        ...
        postResponse = requests.post(url, headers=headers, data=_gen(stream, onSpeechDetectedCallback, onSpeechEndCallback))
...
def _gen(stream, onSpeechDetectedCallback, onSpeechEndCallback):
    """
    :param stream:
    :return:
    """
