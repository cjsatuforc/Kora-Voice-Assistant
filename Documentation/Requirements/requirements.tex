...
\section{Overall Description}
    \subsection{Product Perspective}
		\botname is a natural language interface plugin for Autodesk's Fusion360. 
		However the purpose of \botname goes beyond voice commands, \botname will eventually become an intelligent virtual assitant. 
		Ultimately \botname will be able to automate or make suggestions for basic design tasks.
		\botname will start as just a natural language interface for Fusion360, which will allow users to use voice commands to control Fusion360.
		In addition to voice commands \botname will ask the user questions related to design choices, the responses to these questions will saved for later analysis.
		The responses collected from users will be used to train \botname to ultimately become an intelligent virtual assitant.
    ...
    \subsection{Product Functions}
		...
		Over time \botname will be trained to provide the user more than voice commands.
		\botname is in a way a framework where in \botname can itself gather information it can hopfully use to learn to aid the user.
		\botname will eventually be able to offer design suggestions to user.
		\botname will learn how to do this using machine learning algorithms on the saved responses to the very questions it asks its users.
